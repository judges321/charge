...
var base64 = require('./base64-arraybuffer.js');
...
(function ExportLibrary(root, factory) {
  ...
  var PahoMQTT = (function(my) {
    ...
    var ClientImpl = function(uri, host, port, path, clientId) {
      ...
      for (var key in my.getStorageInfoSync().keys)
    ...
    ClientImpl.prototype._doConnect = function(wsurl) {
      ...
      my.onSocketOpen(scope(this._on_socket_open, this))
      my.onSocketMessage(scope(this._on_socket_message, this))
      my.onSocketError(scope(this._on_socket_error, this))
      my.onSocketClose(scope(this._on_socket_close, this))
    ...
    ClientImpl.prototype.restore = function(mKey) {
      var value = my.getStorageSync({ key: mKey }).data;
      ...
      switch (storedMessage.type) {
        ...
        default:
          throw Error(format(ERROR.INVALID_STORED_DATA, [mKey, value]));
      }

      if (mKey.indexOf("Sent:" + this._localKey) === 0) {
        wireMessage.payloadMessage.duplicate = true;
        this._sentMessages[wireMessage.messageIdentifier] = wireMessage;
      } else if (mKey.indexOf("Received:" + this._localKey) === 0) {
    ...
    ClientImpl.prototype._on_socket_message = function(event) {
      var event_data = base64.decode(event.data)
      this._trace("Client._on_socket_message", event_data);
      var messages = this._deframeMessages(event_data);
        ...
        switch (wireMessage.type) {
          case MESSAGE_TYPE.CONNACK:
            ...
            if (this.connectOptions.cleanSession) {
              for (var key in this._sentMessages) {
                ...
                my.removeStorageSync({ key: "Sent:" + this._localKey + sentMessage.messageIdentifier });
              }
              this._sentMessages = {};

              for (var key in this._receivedMessages) {
                var receivedMessage = this._receivedMessages[key];
                my.removeStorageSync({ key: "Received:" + this._localKey + receivedMessage.messageIdentifier });
              }
              this._receivedMessages = {};
            }
          ...
          case MESSAGE_TYPE.PUBACK:
            ...
            if (sentMessage) {
              ...
              my.removeStorageSync({ key: "Sent:" + this._localKey + wireMessage.messageIdentifier });
              if (this.onMessageDelivered)
          ...
          case MESSAGE_TYPE.PUBREL:
            ...
            my.removeStorageSync({ key: "Received:" + this._localKey + wireMessage.messageIdentifier });
    ...
    ClientImpl.prototype._socket_send = function(wireMessage) {
      ...
      my.sendSocketMessage({
        data: base64.encode(wireMessage.encode()),
        isBuffer: true,
        success: function() {
        },
        fail: function() {
